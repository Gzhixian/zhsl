        ...
        function(e, t) {
            ...
            e("../MainManage").endHttpShowInfo, cc.Class({
                ...
                onLoad: function() {
                    ...
                    this.myFish = this.playerNode.getChildByName("kedou"), this.CreateEnemy(60), this.waterCount = 0, this.randnum = 10, this.angle = 0, this.rotSpeed = 1500, this.addSpeed = 1000, this.maxTypeID = 1, this.canTouchReplay = !1;
                    for (var c = 0; c < 9; c++) {
